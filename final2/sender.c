...
void* Receive(void *arg)//usando la segunda cola, el  sender recibira el mensaje del receiver , utilizando el segundo hilo 
{
...
int main(int argc, char* argv[])//el primer hilo se encarga de  enviar el mensaje del sender al receiver 
{
    ...
    char str[64];
    pthread_t threadID1;
    pthread_create(&threadID1,NULL,&Receive,NULL);
